...
const precioTotal = obtenerPrecioTotal(carrito);
...
function imprimirTabla(array) {
  ...
  botonPagar.innerHTML = "Pagar Carrito";
  botonPagar.className = "btn btn-dark";

  accionesCarrito.appendChild(totalCarrito);
  accionesCarrito.appendChild(botonPagar);
...
async function obtenerNombreUsuario() {
  const { value: login } = await Swal.fire({
    title: 'Ingrese su nombre de usuario de Github',
    input: 'text',
    inputAttributes: {
      autocapitalize: 'off'
    },
